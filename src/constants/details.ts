...
export const stack2: TStacks[] = [
...

  {
    ...
    name: "Framer Motion",
    className: "h-12",
    stackLogo: "/logos/framelogo.svg",
  },
  {
    id: 6,
    name: "Figma",
    className: "h-12",
    stackLogo: "/logos/figmalogo.png",
  },
  { id: 7, name: "Git", className: "h-12", stackLogo: "/logos/gitlogo.svg" },
  {
    id: 8,
    name: "GitHub",
    className: "h-12",
    stackLogo: "/logos/githublogo.png",
  },
];
...
export const projects = [
  {
    ...
    logos: [
      ...
      {
        id: 2,
        image: "/logos/htmllogo.svg",
      },
      {
        id: 3,
        image: "/logos/csslogo.svg",
      },
      {
        id: 4,
  ...
  {
    id: 6,
    href: "https://github.com/AravindBaranitharan/Aravindbaranitharan-portfolio--main",
    title: "Personal Portfolio",
    subTitle: "Built with next-js & tailwind - 2024",
    img: "/p6.jpg",
    logos: [
      {
        id: 1,
